                    ...
                    if (packageInfo != null) {
                        ...
                        molvixAppVersionPref.setOnPreferenceClickListener(preference -> {
                            if (getContext() != null) {
                                ...
                                aboutAppDialogBuilder.setMessage(UiUtils.fromHtml("You are currently using Version <b>" + versionName + "</b> of Molvix.<br/><br/><b>Molvix</b>, an acronym for <b>Mobile Videos</b>, is an easy gateway to all your favorite TV Series and TV Shows."));
